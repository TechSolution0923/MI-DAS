...
<head>
    ...
    <!-- Font Awesome -->
    <link rel="stylesheet" href="<?= $this->config->item('base_folder'); ?>public/css/font-awesome-4.4.0/css/font-awesome.min.css">
    <!-- Ionicons -->
    <link rel="stylesheet" href="<?= $this->config->item('base_folder'); ?>public/css/ionicons-2.0.1/css/ionicons.min.css">
    <!-- DataTables -->
    <link rel="stylesheet" href="<?php echo $this->config->item('base_folder'); ?>public/plugins/datatables/datatables.min.css">
    <!-- Theme style -->
    <link rel="stylesheet" href="<?= $this->config->item('base_folder'); ?>public/plugins/jvectormap/jquery-jvectormap-1.2.2.css">
    ...
    <link href="<?= $this->config->item('base_folder'); ?>public/plugins/pace-master/themes/blue/pace-theme-flash.css" rel="stylesheet"/>
    <link href="<?= $this->config->item('base_folder'); ?>public/plugins/x-editable/bootstrap3-editable/css/bootstrap-editable.css" rel="stylesheet" type="text/css">

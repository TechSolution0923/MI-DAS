  ...
  table.columns().every( function () {
	...
	var table = $(".users-list-table").DataTable({
		...
		buttons: [
		{
			...
			action: function ( e, dt, node, config ) {
				var ValuesOfSearch = '';
				var urltogo = base_url+'users/export_csv';
				document.location.href = urltogo;
			}
		}]
	});
	
		/* Code for the Data Table of target table. */ 
	...
	/* Code for the Data Table of logs table. */ 
	var table = $(".target-list-table1").DataTable({
		"order": [[ 2, "asc" ], [ 1, "asc" ]],
		dom: 'Bfrtip',
		buttons: [
		{
...
$("#repcode, #repcode_2, #repcode_3, #repcode_4, #repcode_5,#repcode_6,#repcode_7,#repcode_8,#repcode_9,#repcode_10").on('keyup', function(){
...
function addRequiredOnKeyUp() {
	...
	var repcode_6Obj = document.getElementById("repcode_6");
	var repcode_7Obj = document.getElementById("repcode_7");
	var repcode_8Obj = document.getElementById("repcode_8");
	var repcode_9Obj = document.getElementById("repcode_9");
	var repcode_10Obj = document.getElementById("repcode_10");
	if(usertypeObj!=null) {
	...
	if(repcode_6Obj!=null && repcode_6Obj.value.trim()) {
		anyone = true;
	}

	if(repcode_7Obj!=null && repcode_7Obj.value.trim()) {
		anyone = true;
	}

	if(repcode_8Obj!=null && repcode_8Obj.value.trim()) {
		anyone = true;
	}

	if(repcode_9Obj!=null && repcode_9Obj.value.trim()) {
		anyone = true;
	}

	if(repcode_10Obj!=null && repcode_10Obj.value.trim()) {
		anyone = true;
	}
	...
	else if(!anyone && "B"!=selected_value && "A"!=selected_value) {
		addRequiredAllK8();
	} else {
		removeRequiredAllK8();
	}	
...
function addRequiredAllK8() {
	...
	if(repcode_6Obj!=null) {
		document.getElementById("repcode_6").setAttribute("required", true);
	}

	if(repcode_7Obj!=null) {
		document.getElementById("repcode_7").setAttribute("required", true);
	}

	if(repcode_8Obj!=null) {
		document.getElementById("repcode_8").setAttribute("required", true);
	}

	if(repcode_9Obj!=null) {
		document.getElementById("repcode_9").setAttribute("required", true);
	}

	if(repcode_10Obj!=null) {
		document.getElementById("repcode_10").setAttribute("required", true);
	}
}
...
function removeRequiredAllK8() {
	...
	if(repcodeObj!=null) {
		document.getElementById("repcode").removeAttribute("required");
	}
	
	if(repcode_2Obj!=null) {
		document.getElementById("repcode_2").removeAttribute("required");
	}
	
	if(repcode_3Obj!=null) {
		document.getElementById("repcode_3").removeAttribute("required");
	}
	
	if(repcode_4Obj!=null) {
		document.getElementById("repcode_4").removeAttribute("required");
	}
	
	if(repcode_5Obj!=null) {
		document.getElementById("repcode_5").removeAttribute("required");
	}

	if(repcode_6Obj!=null) {
		document.getElementById("repcode_6").removeAttribute("required");
	}

	if(repcode_7Obj!=null) {
		document.getElementById("repcode_7").removeAttribute("required");
	}

	if(repcode_8Obj!=null) {
		document.getElementById("repcode_8").removeAttribute("required");
	}

	if(repcode_9Obj!=null) {
		document.getElementById("repcode_9").removeAttribute("required");
	}

	if(repcode_10Obj!=null) {
		document.getElementById("repcode_10").removeAttribute("required");
	}
}
...
function checkUnique() {
	...
	if(a=='B')
	{
		...
		var html = '<p id="branch_err" class="error alert-danger"><span>Please select a Branch for this branch user</span></p>';

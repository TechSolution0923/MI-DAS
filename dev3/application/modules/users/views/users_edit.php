...
<section class="content">
	<div class="nav-tabs-custom">
		<ul class="nav nav-tabs" role="tablist">
			...
			<li role="presentation" class="" id="showSalesRep" data-user="<?php echo $userDetail['userid'];?>"><a href="#salesRepBlock" role="tab" data-toggle="tab" aria-expanded="false">Sales Rep</a></li>		
		</ul>
			...
			<div class="row">
				...
				<?php echo form_open('users/details', array("role"=>"form", "enctype"=>"multipart/form-data", "onsubmit"=>"return checkUnique();"));?>
					<div class="col-xs-12 col-md-8">
						...
						<div class="form-group rep-code hidden">
						  <label>&nbsp;</label>
						  <input type="text" class="form-control small-text frst" placeholder="" name="repcode_6" id="repcode_6" value="<?php echo isset($userDetail['repcode_6'])?$userDetail['repcode_6']:"";?>" <?php echo $disabled;?> >
						  <input type="text" class="form-control small-text" placeholder="" name="repcode_7" id="repcode_7" value="<?php echo isset($userDetail['repcode_7'])?$userDetail['repcode_7']:"";?>" <?php echo $disabled;?> >
						  <input type="text" class="form-control small-text" placeholder="" name="repcode_8" id="repcode_8" value="<?php echo isset($userDetail['repcode_8'])?$userDetail['repcode_8']:"";?>" <?php echo $disabled;?> >
						  <input type="text" class="form-control small-text" placeholder="" name="repcode_9" id="repcode_9" value="<?php echo isset($userDetail['repcode_9'])?$userDetail['repcode_9']:"";?>" <?php echo $disabled;?> >
						  <input type="text" class="form-control small-text lst" placeholder="" name="repcode_10" id="repcode_10" value="<?php echo isset($userDetail['repcode_10'])?$userDetail['repcode_10']:"";?>" <?php echo $disabled;?> >
						</div>
						...
						<div class="row">
							<div class="form-group">
								...
								<div class="col-sm-2">
									<div class="checkbox">
										<label>
										<input type="checkbox" name="salesemail" id="salesemail" <?php echo isset($userDetail['salesemail']) && ($userDetail['salesemail']==1)?"checked":"";?> value="1" <?php echo $disabled;?>>
										Sales Email
										</label>
									</div>
								</div>
						...
						<div class="row">
							<div class="form-group">
								...
								<div class="col-sm-2">
									<div class="checkbox">
										<label>
											<input type="checkbox" name="seeomr" id="seeomr" <?php echo isset($userDetail['seeomr']) && ($userDetail['seeomr']==1)?"checked":"";?> value="1" <?php echo $disabled;?>>
											See OMR
										</label>
									</div>
								</div>
								<div class="col-sm-2">
									<div class="checkbox">
										<label>
											<input type="checkbox" name="seeprojectedsales" id="seeprojectedsales" <?php echo isset($userDetail['seeprojectedsales']) && ($userDetail['seeprojectedsales']==1)?"checked":"";?> value="1" <?php echo $disabled;?>>
											See Projected Sales
										</label>
									</div>
								</div>
								<div class="col-sm-2">
									<div class="checkbox">
										<label>
											<input type="checkbox" name="seeprojectedsalesyear" id="seeprojectedsalesyear" <?php echo isset($userDetail['seeprojectedsalesyear']) && ($userDetail['seeprojectedsalesyear']==1)?"checked":"";?> value="1" <?php echo $disabled;?>>
								...
								<div class="col-sm-2">
									<div class="checkbox">
										<label>
											<input type="checkbox" name="seeorderfulfillment" id="seeorderfulfillment" <?php echo isset($userDetail['seeorderfulfillment']) && ($userDetail['seeorderfulfillment']==1)?"checked":"";?> value="1" <?php echo $disabled;?>>
						...
						<div class="row">
							<div class="form-group">
								...
								<div class="col-sm-2">
									<div class="checkbox">
										<label>
										<input type="checkbox" name="edittargets" id="edittargets" <?php echo isset($userDetail['edittargets']) && ($userDetail['edittargets']==1)?"checked":"";?> value="1" <?php echo $disabled;?>>
										Edit Targets
										</label>
									</div>
								</div>
							...
							<div class="col-xs-12">
							  <div class="box">
								...
								<div class="box-footer no-border">
									...
									<hr>
									<a href="<?= base_url(); ?>/images/import_user_target.csv" download>Sample File (Use Only CSV with headings)</a> 
									<?php } ?>
								</div>	
					...
					<?php echo form_open('users/kpimodify', array("role"=>"form", "id"=>"userFrm"));?>
						<div class="col-md-8 col-xs-12">
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" placeholder="kpi threshold 1" name="kpithreshold1" id="kpithreshold2" value="<?php echo isset($userDetail['kpithreshold1'])?$userDetail['kpithreshold1']:"";?>" required <?php echo $disabled;?>>
								<?php echo form_error('kpithreshold1'); ?>
							</div>
							
							<div class="form-group">
								<label>KPI Threshhold2</label>
								<input type="text" class="form-control" placeholder="kpi threshold " name="kpithreshold2" id="kpithreshold2" value="<?php echo isset($userDetail['kpithreshold2'])?$userDetail['kpithreshold2']:"";?>" required <?php echo $disabled;?>>
		  ...
		  <div class="tab-pane" id="salesRepBlock">
			<div class="row">
				<div class="col-xs-12">
					...
					<button type="submit" name="addnew" class="btn btn-success pull-right bottom5" onclick="return openModal('#addRepModal', 'newRep/<?php echo $account; ?>');"><i class="fa fa-fw fa-plus-circle"></i>Add Sales Rep</button>

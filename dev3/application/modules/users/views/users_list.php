						...
						?>
							<tr>
								...
								<td>
									...
									<span>
									<?php echo form_open('users/details', array('id'=>'frm2'.$row['userid']));?>
										<input type="hidden" name="userid" value="<?php echo $row['userid'];?>" />
										<input type="hidden" name="type" value="view" />
										<span onclick="<?php echo $canSubmit;?>document.getElementById('frm<?php echo $row['userid'];?>').submit();" class="transform-link"><i class="fa fa-fw fa-info"></i></span>
									<?php echo form_close();?>
									</span>
									<span>
										<?php echo form_open('users/details');?>

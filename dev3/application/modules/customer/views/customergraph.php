		...
		<div class="col-md-12">	<!-- Main left hand side of dashboard -->
			...
			<div class="nav-tabs-custom">
				<ul class="nav nav-tabs pull-right">
					<li class="active"><a href="#threeyearsaleschart" data-toggle="tab" onclick="manage_cookie('threeyearsalesanalysispacchart','N')"><i class="fa fa-line-chart"></i></a></li>
					<li onclick="manage_cookie('threeyearsalesanalysispacchart','Y')" id="threeyearsalesanalysispactable_nav"><a href="#threeyearsalestable" data-toggle="tab" class="threeyearsalestable-link"><span class="threeyearsalestable-sales"><?= $currency_symbol; ?></span> / <span class="threeyearsalestable-quantities">Qty&nbsp;&nbsp;</span><i class="fa fa-table"></i></a></li>
				</ul>

...
(function() {
    var a = function(b, c) {
                ...
                if (C.lockRatio) {
                    ...
                    if (E.getCustomData('isReady') == 'true')
                        if (this.id == 'txtHeight') {
                            if (B && B != '0') B = Math.round(E.$.width * (B / E.$.height));
                            if (!isNaN(B)) C.setValueOf('info', 'txtWidth', B);
                        } else {
                            if (B && B != '0') B = Math.round(E.$.height * (B / E.$.width));
        ...
        function m() {
            var B = arguments,
                C = this.getContentElement('advanced', 'txtdlgGenStyle');
            C && C.commit.apply(C, B);
            this.foreach(function(D) {
                if (D.commit && D.id != 'txtdlgGenStyle') D.commit.apply(D, B);
            });
        };
        var n;
        ...
        var p = function(B, C) {
                ...
                if (C == 'check') {
                    if (!B.userlockRatio && D.getCustomData('isReady') == 'true') {
                        var E = B.getValueOf('info', 'txtWidth'),
                            F = B.getValueOf('info', 'txtHeight'),
                            G = D.$.width * 1000 / D.$.height,
                            H = E * 1000 / F;
                        B.lockRatio = false;
                        if (!E && !F) B.lockRatio = true;
                        else if (!isNaN(G) && !isNaN(H))
                            if (Math.round(G) == Math.round(H)) B.lockRatio = true;
                    }
            ...
            q = function(B) {
                ...
                if (C.getCustomData('isReady') == 'true') {
                    var D = B.getContentElement('info', 'txtWidth'),
                        E = B.getContentElement('info', 'txtHeight');
        ...
        return {
            ...
            onShow: function() {
                ...
                if (E) {
                    ...
                    if (F.count() == 1) {
                        ...
                        if (G == 'img' || G == 'input') {
                            ...
                            if (H.imageElement.getName() == 'img') H.imageEditMode = 'img';
                            else if (H.imageElement.getName() == 'input') H.imageEditMode = 'input';
                        }
                    }
                    if (c == 'image') H.setupContent(e, E);
                }
                ...
                } else H.imageElement = B.document.createElement('img');
                p(H, true);
            ...
            onOk: function() {
                ...
                if (C.imageEditMode) {
                    ...
                    if (c == 'image') C.imageElement = b.document.createElement('img');
                    else {
                        C.imageElement = b.document.createElement('input');
                ...
                if (!C.linkEditMode) C.linkElement = b.document.createElement('a');
                ...
                if (!C.imageEditMode) {
                    if (C.addLink) {
                        ...
                        } else b.insertElement(C.imageElement);
                    } else b.insertElement(C.imageElement);
            ...
            onHide: function() {
                var B = this;
                if (B.preview) B.commitContent(g, B.preview);
            ...
            contents: [{
                ...
                elements: [{
                    ...
                    setup: function(B, C) {
                        if (B == d) this.setValue(C.getAttribute('alt'));
                    },
                    commit: function(B, C) {
                        var D = this;
                        if (B == d) {
                            if (D.getValue() || D.isChanged()) C.setAttribute('alt', D.getValue());
                        } else if (B == f) C.setAttribute('alt', D.getValue());
                        else if (B == g) C.removeAttribute('alt');
                    }
                }, {
                    type: 'hbox',
                    children: [{
                            ...
                            children: [{
                                ...
                                commit: function(B, C, D) {
                                    ...
                                    if (B == d || B == f) {
                                        ...
                                        if (!D && B == d) C.removeAttribute('border');
                                    } else if (B == g) {
                                ...
                                setup: function(B, C) {
                                    if (B == d) {
                                        var D, E, F, G = C.getStyle('margin-left'),
                                            H = C.getStyle('margin-right');
                                        G = G && G.match(j);
                                        H = H && H.match(j);
                                        E = parseInt(G, 10);
                                        F = parseInt(H, 10);
                                ...
                                commit: function(B, C, D) {
                                    ...
                                    if (B == d || B == f) {
                                        ...
                                        if (!D && B == d) C.removeAttribute('hspace');
                                    } else if (B == g) {
                                ...
                                setup: function(B, C) {
                                    if (B == d) {
                                        var D, E, F, G = C.getStyle('margin-top'),
                                            H = C.getStyle('margin-bottom');
                                        G = G && G.match(j);
                                        H = H && H.match(j);
                                        E = parseInt(G, 10);
                                        F = parseInt(H, 10);
                                ...
                                commit: function(B, C, D) {
                                    ...
                                    if (B == d || B == f) {
                                        ...
                                        if (!D && B == d) C.removeAttribute('vspace');
                                    } else if (B == g) {
                                ...
                                commit: function(B, C, D) {
                                    ...
                                    } else if (B == g) C.removeStyle('float');
                                }
                            }]
                        }]
                    }, {
                ...
                elements: [{
                    ...
                    setup: function(B, C) {
                        if (B == e) this.setValue(C.getAttribute('target') || '');
                    },
                    commit: function(B, C) {
                        if (B == e)
                ...
                elements: [{
                    ...
                    children: [{
                        ...
                        setup: function(B, C) {
                            if (B == d) this.setValue(C.getAttribute('id'));
                        },
                        commit: function(B, C) {
                            if (B == d)
                                if (this.getValue() || this.isChanged()) C.setAttribute('id', this.getValue());
                        }
                    }, {
                        id: 'cmbLangDir',
                        type: 'select',
                        ...
                        setup: function(B, C) {
                            if (B == d) this.setValue(C.getAttribute('dir'));
                        },
                        commit: function(B, C) {
                            if (B == d)
                                if (this.getValue() || this.isChanged()) C.setAttribute('dir', this.getValue());
                        }
                    }, {
                        type: 'text',
                        id: 'txtLangCode',
                        ...
                        'default': '',
                        setup: function(B, C) {
                            if (B == d) this.setValue(C.getAttribute('lang'));
                        },
                        commit: function(B, C) {
                            if (B == d)
                                if (this.getValue() || this.isChanged()) C.setAttribute('lang', this.getValue());
                        }
                    }]
                }, {
                    type: 'text',
                    ...
                    setup: function(B, C) {
                        if (B == d) this.setValue(C.getAttribute('longDesc'));
                    },
                    commit: function(B, C) {
                        if (B == d)
                            if (this.getValue() || this.isChanged()) C.setAttribute('longDesc', this.getValue());
                    }
                }, {
                    type: 'hbox',
                    widths: ['50%', '50%'],
                    children: [{
                        ...
                        'default': '',
                        setup: function(B, C) {
                            if (B == d) this.setValue(C.getAttribute('class'));
                        },
                        commit: function(B, C) {
                            if (B == d)
                                if (this.getValue() || this.isChanged()) C.setAttribute('class', this.getValue());
                        }
                    }, {
                        type: 'text',
                        id: 'txtGenTitle',
                        ...
                        setup: function(B, C) {
                            if (B == d) this.setValue(C.getAttribute('title'));
                        },
                        commit: function(B, C) {
                            var D = this;
                            if (B == d) {
                                if (D.getValue() || D.isChanged()) C.setAttribute('title', D.getValue());
                            } else if (B == f) C.setAttribute('title', D.getValue());
                            else if (B == g) C.removeAttribute('title');
                        }
                    }]
                }, {
                    type: 'text',
                    ...
                    setup: function(B, C) {
                        if (B == d) {
                            ...
                            if (!D && C.$.style.cssText) D = C.$.style.cssText;
                            this.setValue(D);
                    ...
                    commit: function(B, C) {
                        if (B == d && (this.getValue() || this.isChanged())) C.setAttribute('style', this.getValue());
                    }
                }]
            }]
        };
